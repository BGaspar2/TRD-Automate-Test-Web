...
import { generarDniArgentinaValido, generarTelefonoArgentina, generarNombreAleatorio } from '../../../utils/documentGenerator.js';
import { ejecutarPaso } from '../../../utils/pasos.js';

test('Flujo E2E - Creación de cuenta con código OTP (Argentina)', async ({ page }, testInfo) => {
    ...
    await ejecutarPaso(page, testInfo, {
        ...
        descripcion: 'Ingreso al portal de KFC Argentina y apertura del formulario de autenticación'
    }, async () => {
    ...
    await ejecutarPaso(page, testInfo, {
        ...
        const dniValido = generarDniArgentinaValido();
        const telefono = generarTelefonoArgentina();
        ...
        console.log("📋 [Datos de Registro Generados - Argentina]:", datosUsuario);
