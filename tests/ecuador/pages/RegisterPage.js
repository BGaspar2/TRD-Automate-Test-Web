...
export class RegisterPage {
    ...
    constructor(page) {
        ...
        this.botonIngresarHeader = page.getByRole('button', { name: /^ingresar$/i })
            .or(page.locator('header button, nav button, [class*="Header"] button').filter({ hasText: /^ingresar$/i }))
            .or(page.getByRole('button', { name: /ingresar|iniciar sesión|login/i }));
    ...
    async completarPerfilPostOtp(datos) {
        ...
        console.log("Activando checkboxes obligatorios de Términos y DeUna...");
