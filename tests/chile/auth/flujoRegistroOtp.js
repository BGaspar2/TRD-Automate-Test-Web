...
import { generarRutChileValido, generarTelefonoChile, generarNombreAleatorio } from '../../../utils/documentGenerator.js';
import { ejecutarPaso } from '../../../utils/pasos.js';

test('Flujo E2E - Creación de cuenta con código OTP (Chile)', async ({ page }, testInfo) => {
    ...
    await ejecutarPaso(page, testInfo, {
        ...
        descripcion: 'Ingreso al portal de KFC Chile y apertura del formulario de autenticación'
    }, async () => {
    ...
    await ejecutarPaso(page, testInfo, {
        ...
        const rutValido = generarRutChileValido(true);
        const telefono = generarTelefonoChile();
        ...
        console.log("📋 [Datos de Registro Generados - Chile]:", datosUsuario);
