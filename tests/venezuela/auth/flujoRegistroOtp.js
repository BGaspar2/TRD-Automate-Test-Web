...
import { generarCedulaVenezuelaValida, generarTelefonoVenezuela, generarNombreAleatorio } from '../../../utils/documentGenerator.js';
import { ejecutarPaso } from '../../../utils/pasos.js';

test('Flujo E2E - Creación de cuenta con código OTP (Venezuela)', async ({ page }, testInfo) => {
    ...
    await ejecutarPaso(page, testInfo, {
        ...
        descripcion: 'Ingreso al portal de KFC Venezuela y apertura del formulario de autenticación'
    }, async () => {
    ...
    await ejecutarPaso(page, testInfo, {
        ...
        const cedulaValida = generarCedulaVenezuelaValida();
        const telefono = generarTelefonoVenezuela();
        ...
        console.log("📋 [Datos de Registro Generados - Venezuela]:", datosUsuario);
