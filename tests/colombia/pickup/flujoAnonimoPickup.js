...
async function ejecutarFlujoPickupColombia(page, testInfo, metodoPago) {
    ...
    console.log(`✅ Flujo Colombia Pickup (${metodoPago}) finalizado exitosamente. Orden: [ ${codigoPedidoGenerado} ]`);
}

// =========================================================================
// 🇨🇴 Casos de Prueba E2E - Métodos de Pago Colombia Pickup
// =========================================================================

test('Flujo E2E - Compra Pickup con Tarjeta Débito/Crédito (Colombia)', async ({ page }, testInfo) => {
