...
import { generarCedulaColombiaValida, generarTelefonoColombia, generarNombreAleatorio } from '../../../utils/documentGenerator.js';
import { ejecutarPaso } from '../../../utils/pasos.js';

test('Flujo E2E - Creación de cuenta con código OTP (Colombia)', async ({ page }, testInfo) => {
    ...
    await ejecutarPaso(page, testInfo, {
        ...
        descripcion: 'Ingreso al portal de KFC Colombia y apertura del formulario de autenticación'
    }, async () => {
    ...
    await ejecutarPaso(page, testInfo, {
        ...
        const cedulaValida = generarCedulaColombiaValida();
        const telefono = generarTelefonoColombia();
        ...
        console.log("📋 [Datos de Registro Generados - Colombia]:", datosUsuario);
